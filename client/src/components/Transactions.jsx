...
const TransactionsCard = ({ addressTo, addressFrom, timestamp, message, keyword, amount, url }) => {
    ...
    return (
        <div className="bg-pink-900 m-4 flex flex-1 2xl:min-w-[450px] 2xl:max-w-[500px] sm:min-w-[270px] sm:max-w-[300px] min-w-full flex-col p-3 rounded-md hover:shadow-2xl">
            ...
            <div className="flex flex-col items-center w-full mt-3">
                ...
                <div className="bg-black p-3 px-5 w-max rounded-3xl -mt-5 shadow-2xl">
                    <p className="text-green-500 font-bold">{timestamp}</p>
                </div>
        ...
        <div className="flex w-full justify-center items-center 2xl:px-20 gradient-bg-transactions">
            <div className="flex flex-col md:p-12 py-12 px-4">
                { currentAccount ? (
                    ...
                    <h3 className="text-white text-3xl text-center my-2">
                        Conecta a sua conta no Metamask para visualizar suas Transações
                    </h3>
                )}
